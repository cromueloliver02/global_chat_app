...
/// @nodoc
@JsonSerializable()
class _$ChatRoomImpl extends _ChatRoom with DiagnosticableTreeMixin {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ChatRoom(id: $id, name: $name, description: $description)';
  }
...
abstract class _ChatRoom extends ChatRoom {
  const factory _ChatRoom(
      ...
      required final String description}) = _$ChatRoomImpl;
